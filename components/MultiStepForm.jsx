...
const MultiStepForm = () => {
    ...
    return (
        <div className="flex justify-center">
            ...
            {step === 1 && (
             <div className="min-w-[30rem] max-w-[80%] border border-gray-300 rounded-lg
             p-16">
                    <h3 className='mb-16'>Vôtre identité pour vous recontacter si besoin</h3>
            ...
            {step === 2 && answers.color !== 'blue' && (
                ...
                p-16">
                    <div className="flex flex-col">
                        ...
                        <h3 className='mb-24 text-lg text-center'>Il y a t'il un danger imminent ?</h3>
                        ...
                        <div className='mt-12'>
                            {/* name="color" */}
                            <button type="submit" value={answers.color || ''} onChange={handleAnswerChange} 
                            class="p-3 mx-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none 
                            focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto py-2.5 text-center 
                            dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            onClick={nextStep}>Suivant</button>
                            {/* <input name="reason" onChange={handleAnswerChange} value={answers.reason || ''} /> */}
                            <button className="ml-4 border py-2 px-4  border-gray-300 rounded-lg"
