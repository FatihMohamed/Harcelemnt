        ...
        <div>
            ...
            {step === 1 && (
                ...
                <div className='max-w-[80%]'>
                    ...
                    {/* name="color" */}
                    <button type="submit" value={answers.color || ''} onChange={handleAnswerChange}  class="ml-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"                   
            ...
            {step === 2 && answers.color === 'blue' && (
                <div>
                    <h3>You chose blue! Why do you like blue?</h3>
            ...
            {step === 2 && answers.color !== 'blue' && (
                <div>
                    <h3>Why didn't you choose blue?</h3>
                    <input name="reason" onChange={handleAnswerChange} value={answers.reason || ''} />
                    <button onClick={prevStep}>Back</button>
                    <button onClick={nextStep}>Next</button>
                </div>
