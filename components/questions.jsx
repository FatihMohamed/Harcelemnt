    ...
    <div className="flex items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover custom-img">
      ...
      <div className="p-5 text-white z-[2] mt-[-10rem]">
        ...
        <label className="text-lg" htmlFor="descriptionPhysique">
          Pouvez-vous décrire en détail les incidents de harcèlement physique
          que vous avez subis ?
        </label>
        <textarea
...
export const Call = ({ heading, message }) => {
  const handleButtonClick = () => {
    ...
    window.location.href =
      "https://www.masecurite.interieur.gouv.fr/fr/fiches-pratiques/famille-et-aides-aux-victimes/17-police-secours";
  };
